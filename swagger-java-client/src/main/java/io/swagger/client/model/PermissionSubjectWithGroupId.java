...
public class PermissionSubjectWithGroupId {
  ...
  **/
   ...
   * @return identifier
  **/
  @Schema(required = true, description = "for `type=user`, identifier should be user's accountId or `anonymous` for anonymous users  for `type=group`, identifier should be ID of the group")
