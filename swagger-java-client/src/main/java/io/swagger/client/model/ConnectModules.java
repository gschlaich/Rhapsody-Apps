...
public class ConnectModules {
   ...
   * @return modules
  **/
  @Schema(required = true, description = "A list of app modules in the same format as the `modules` property in the [app descriptor](https://developer.atlassian.com/cloud/confluence/app-descriptor/).")
