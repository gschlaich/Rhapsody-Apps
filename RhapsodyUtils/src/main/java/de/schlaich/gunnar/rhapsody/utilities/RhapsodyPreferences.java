...
public class RhapsodyPreferences {
	...
	public static boolean isWindowsDarkMode()
	{
		...
		return false; // Im Zweifel lieber Light Mode annehmen
	}
	
	public static void setUIDarkmode()
	{
		try
		{
	...
	public static void setUILightmode()
	{
