	...
	private void handle(HttpExchange ex) throws IOException
	{
		...
		try
		{
			...
			else if ("initialize".equals(method))
			{
				...
				// Request enth�lt u.a. protocolVersion, clientInfo, capabilities (des Clients)
			    ...
			    // Ob wir Tool-Liste-�nderungen pushen k�nnten � hier false:
			    ...
			    // keine speziellen Felder n�tig � das Vorhandensein signalisiert Support
			...
			else if ("notifications/initialized".equals(method))
			{
			    ...
			    // Kein Ergebnis n�tig; einfach acknowledge.
